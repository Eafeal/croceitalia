...
<div class="container">
  ...
  <div class="header">
    <a href="/index.html"><img src="/images/logo.png" alt="ASSOCONS Software &amp; Solutions"/></a>
  ...
  <div id="sidebar">
    ...
    <ul class="boxes">
      <li>
        <a class="left box5" href="/site/croceitalia/genera/xml">
          <div>
      ...
      <li>
        <a class="right box3" href="/normativa-e-scadenze.html">
          <div>
          <h3>Normativa e Scadenze</h3>
          </div>
        </a>
      </li>
      <li>
        <a class="center box4" href="/prova-gratis.html">
          <div>
  ...
  <div id="content">
    <Strong>Si &egrave; verificato il seguente errore processando la tua richiesta</Strong></br>
    <h1>Errore HTTP 405 - Method not allowed (Metodo non consentito)</h1></br>
    <Strong>Se l'errore dovesse persistere ti preghiamo di <a href="/contatti.html">contattarci</a> per segnalarci il codice d'errore qui sopra riportato.</Strong> 
	<br/> 
	<br/> 
