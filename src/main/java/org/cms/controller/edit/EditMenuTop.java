 ...
 */
@Controller
public class EditMenuTop {

	/**
	 * 
	 */
	@RequestMapping(value = "menutop/update/{id}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "menutop/newRelation", method = RequestMethod.POST)
