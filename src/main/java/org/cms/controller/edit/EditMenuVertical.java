 ...
 */
@Controller
public class EditMenuVertical {

	/**
	 * 
	 */
	@RequestMapping(value = "colbanner/update/{id}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "colbanner/newRelation", method = RequestMethod.POST)
