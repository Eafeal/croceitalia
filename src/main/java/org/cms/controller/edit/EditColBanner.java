 ...
 */
@Controller
public class EditColBanner {

	/**
	 * 
	 */
	@RequestMapping(value = "menuvertical/update/{id}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "menuvertical/newRelation", method = RequestMethod.POST)
