...
public class Test {
 ...
 private static void aggiungiMetaDati(Document document) {
  document.addTitle("Croce italia");
 ...
 private static void aggiungiPrefazione(Document document) throws DocumentException {
  ...
  prefazione.add(new Paragraph("Croce Ialia", bigFont));
  ...
  Anchor anchor = new Anchor("www.croceitaliabernate.it");
  anchor.setName("LINK");
  anchor.setReference("http://www.croceitaliabernate.it/");
