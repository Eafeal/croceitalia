...
<#if utente.isLogged()>	
	...
	<fieldset style="border: 0; border-bottom: 1px solid #999; padding: 5px 0; margin-bottom: 30px; font-size: 16px; line-height: 50px;">
        ...
        Profilo: <span style="display: inline-block; font-weight: bold; margin-right: 50px;">730UserASL</span>
    ...
    <ul class="menu-in-page">
      <li class="${classCSV}"><a href="javascript:esegui('CSV')">Prestazioni ASL (csv)</a></li>
	  <!--li class="${classMPL}"><a href="javascript:esegui('ExcelMPL')">Prestazioni MMG/PDF</a></li-->
	  <li class="${classSSA}"><a href="javascript:esegui('ExcelATS')">Prestazioni SSA/ASL (excel)</a></li>
    </ul>
	</center>
	...
	<input type="button" class="invia" value="Cancella KO" onClick="cancellaKO()"/>&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="button" class="invia" value="Cancella TUTTO" onClick="cancellaTutto()"/>		
