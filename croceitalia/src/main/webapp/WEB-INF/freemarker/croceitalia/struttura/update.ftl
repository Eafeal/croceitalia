                    ...
                    <table>
                        <tbody>
                            <tr class="prop">
                         	...
                         	<tr class="prop">
                            	<td align="top" class="name"><label for="fk_id_tipologia_struttura">Tipologia Struttura</label></td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value">
                                    <input type="text" id="nome" name="nome" size="25" maxlength="40" value="${struttura.getNome()}" placeholder="Nome struttura"/>
                                </td>
                            </tr>
                             <tr class="prop" >
                             	<td align="top" class="descrizione"><label for="descrizione_breve"> Descrizione breve </label></td>
                                <td align="top" class="value" >
                                    <input type="text" id="descrizione_breve" name="descrizione_breve" size="25" maxlength="50" value="${struttura.getDescrizione_breve()}" placeholder="Descrizione"   />
                             	</td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name"><label for="telefono">Telefono </label></td>
                                <td valign="top" class="value">
                                    <input type="text" id="telefono" name="telefono" size="18" maxlength="20" value="${struttura.getTelefono()}" placeholder="Telefono principale"/>
                                    <input type="text" id="email" name="email"  size="25" maxlength="40" value="${struttura.getEmail()}" placeholder="Indirizzo e-mail"   />
                                </td>
                            </tr>
                           <tr class="prop">
                                <td valign="top" class="name"><label for="via">Indirizzo</label></td>
                                <td valign="top" class="value">
                                    <input type="text" id="via" name="via" size="20" maxlength="40" value="${struttura.getVia()}" placeholder="Via"/>
                                    <input type="text" id="cap" name="cap" size="7" maxlength="5" value="${struttura.getCap()}" placeholder="Cap"/>
                                    <input type="text" id="comune" name="comune" size="20" maxlength="40" value="${struttura.getComune()}" placeholder="Comune"/>
                            ...
                            <tr class="prop" >
                                ...
                                <td align="top" class="value" >
                                    ...
                                    <input type="text" id="cod_struttura" name="cod_struttura"  size="8" maxlength="6" value="${struttura.getCod_struttura()}" placeholder="Struttura"   />
                             	</td>
                            </tr>             
