        ...
        <div class="body">
            ...
            <form id="strutturaForm" name="strutturaForm" action="/edit/struttura/save" method="post" >
                   ...
                   <table>
                        <tbody>
                        <tr class="prop">
                            <td valign="top" class="tipo"><label for="fk_id_tipologia_struttura">Tipologia Struttura</label></td>
                            ...
                            <tr class="prop">
                                ...
                                <td align="top" class="value">
                                    <input type="text" id="nome" name="nome"  size="25" maxlength="40" value="" placeholder="Nome struttura"  />
                                </td> 
                            </tr>
                            <tr class="prop" >
                             	<td align="top" class="descrizione"><label for="descrizione_breve">Descrizione breve</label></td>
                                <td align="top" class="value" >
                                    <input type="text" id="descrizione_breve" name="descrizione_breve" size="25" maxlength="50" value="" placeholder="Descrizione" />
                             	</td>
                            </tr>
                            <tr class="prop">
                             	<td align="top" class="telefono"><label for="telefono">Recapiti</label></td>
                                <td align="top" class="value">
                                    <input type="text" id="telefono" name="telefono"  size="18" maxlength="20" value=""  placeholder="Telefono principale"  />
                             	    <input type="text" id="email" name="email"  size="25" maxlength="40" value="" placeholder="Indirizzo e-mail"   />
                            ...
                            <tr class="prop" >
                                ...
                                <td align="top" class="value" >
                                    ...
                                    <input type="text" id="cod_asl" name="cod_asl"  size="6" maxlength="3" value="" placeholder="Asl"   />
