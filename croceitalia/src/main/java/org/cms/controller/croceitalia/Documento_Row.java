...
@Entity
@Table(name = "Documento_Row")
@NamedQuery(name = "Documento_Row.loadAll", query = "SELECT OBJECT(obj) FROM Documento_Row obj")
public class Documento_Row extends Model {
	...
	public Documento_Row(Integer id_documento_righe, Integer fk_id_documento_testata,/* Integer fk_id_paziente,*/
