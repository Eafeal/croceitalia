...
public class OggettoPdf {
	...
	//public static List<Documento_Righe> oggettoPdf() {
		...
		// 45));
		// row.add(new Documento_Row(1, 2, "pablo escobar", 3, "maggio", 70, 45, "", "monza", "galeazzi", 0, 23, "N",
		// 67));
		// row.add(new Documento_Row(1, 2, "axel palmieri", 3, "aprile", 59, 23, "", "paderno", "niguarda", 0, 23, "S",
		// 43));
		// row.add(new Documento_Row(1, 2, "frnco fdgdhnhd", 3, "maggio", 70, 45, "", "monza", "galeazzi", 0, 23, "N",
		// 0));
		// row.add(new Documento_Row(1, 2, "frnco palmieri", 3, "aprile", 59, 23, "", "paderno", "niguarda", 0, 23, "S",
		// 10));
		// row.add(new Documento_Row(1, 2, "pablo escobar", 3, "maggio", 70, 45, "", "monza", "galeazzi", 0, 23, "N",
